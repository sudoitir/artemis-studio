...
### 11.3 `MESSAGE_BODY_FULL` — probed → observed (ADR-0020 correction)
...
4. **`MESSAGE_BODY_FULL` is observed, not probed** — ADR-0020's Decision and the
