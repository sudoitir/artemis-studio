...
| [0080](0080-flow-graph-elk-layered-layout-and-svg-motion.md) | The flow graph is laid out by ELK layered in a web worker with fixed columns, and shows flow as budgeted SVG `animateMotion` dots that pause natively and never carry meaning alone |
