...
public class McpTuningTools {
    ...
    public McpSchema.CallToolResult connectionAction(
        ...
        if (op.nodeScoped()) {
            ...
            return McpErrors.guard(() -> {
                ...
                requireConfirmation(preview.target().label(), confirm);
    ...
    private Object declare(UUID clusterId, String document, String xml, boolean dry, String confirm) {
        ...
        requireConfirmation(current.clusterName(), confirm);
    ...
    private McpViews.ConfigApplyOutcome applyConfig(
        ...
        if (!dry) {
            requireConfirmation(brokerConfig.get(clusterId).clusterName(), confirm);
        }
