...
class McpBrokerConfigRealBrokerTest extends PostgresIntegrationTest {
    ...
    @Autowired
    io.github.sudoitir.artemisstudio.service.ClusterService clusterService;
    ...
    void setUp() throws Exception {
        ...
        var attempt = clusterService.register(new RegisterClusterRequest(
                ...
                null,
                null));
        if (!(attempt instanceof io.github.sudoitir.artemisstudio.service.Attempt.Ok<ClusterDetail> ok)) {
