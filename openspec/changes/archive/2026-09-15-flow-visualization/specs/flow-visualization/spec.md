...
Shows, for one cluster, which clients produce to which addresses, how those addresses route
into queues through bindings, diverts, bridges and cluster redistribution, and which clients
consume them — with live, honestly sourced rates, stated bounds and faults in words.
