...
export const COLUMNS: CatalogueColumn[] = [
  ...
  { name: 'queue', type: 'string', evaluation: 'TARGET', description: 'The queue the message is on.' },
  { name: 'address', type: 'string', evaluation: 'TARGET', description: 'The address the queue is bound to.' },
  { name: 'node', type: 'string', evaluation: 'TARGET', description: 'The broker node holding the message.' },
  { name: 'priority', type: 'number', evaluation: 'PUSHDOWN', description: 'JMS priority, 0-9.' },
  { name: 'durable', type: 'boolean', evaluation: 'PUSHDOWN', description: 'Whether the message is persistent.' },
  { name: 'timestamp', type: 'timestamp', evaluation: 'PUSHDOWN', description: 'When the broker took the message.' },
  {
    name: 'expiration',
    type: 'timestamp',
    evaluation: 'PUSHDOWN',
  ...
  { name: 'size', type: 'number', evaluation: 'PUSHDOWN', description: 'Encoded size in bytes.' },
  { name: 'jmsType', type: 'string', evaluation: 'PUSHDOWN', description: 'The JMSType header.' },
  { name: 'correlationId', type: 'string', evaluation: 'PUSHDOWN', description: 'The correlation id.' },
  { name: 'groupId', type: 'string', evaluation: 'PUSHDOWN', description: 'The message group id.' },
  { name: 'userId', type: 'string', evaluation: 'PUSHDOWN', description: 'The user id the producer set.' },
  { name: 'messageType', type: 'number', evaluation: 'SCAN', description: 'The numeric core message type.' },
  {
    name: 'replyTo',
    type: 'string',
    evaluation: 'SCAN',
